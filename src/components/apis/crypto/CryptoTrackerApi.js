...
const CryptoTrackerApi = () => {
	...
	useEffect(() => {
		axios
			.get("https://api.coinstats.app/public/v1/coins?skip=0&limit=12")
			.then((res) => {
				...
				<div className='cSection__container__split'>
					<div className='cSection__container__split__left'>
						...
						<p>
							...
							elit. Tenetur iure omnis impedit obcaecati
							dignissimos labore quam voluptate necessitatibus
							repellendus reiciendis!ing elit. Hic, ea.
						</p>
					</div>
